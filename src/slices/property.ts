...
const slice = createSlice({
	...
	reducers: {
		...
		setInitialState: (state: propertyState, action): void => {
			...
			state.parentCategory = payload.parentCategory || state.parentCategory;
			...
			state.availableAfter = payload.availableAfter || state.availableAfter;
			state.keyCode = payload.keyCode || state.keyCode;
			state.auction = payload.auction || state.auction;
			state.debatablePrice = payload.debatablePrice || state.debatablePrice;
