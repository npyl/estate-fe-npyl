        ...
        >
            ...
            <DialogContent sx={{padding:"0"}}>
                ...
                {(image1.url && image2.url) && (
                    <>
                        <ComparisonImage isSelected={selectedKey === image1.key} src={image1.url} alt="image 1" onClick={() => handleImageClick(image1.key)} /> 
                        <ComparisonImage isSelected={selectedKey === image2.key} src={image2.url} alt="image 1" onClick={() => handleImageClick(image2.key)} />
                    </>
                )}
            ...
            >
                <Stack direction={"row"} justifyContent={"right"} spacing={1}>
                    <Button variant="contained" color="primary" onClick={handleSetMain}>
                        Set Main
                    </Button>
                    <Button
                        variant="outlined"
