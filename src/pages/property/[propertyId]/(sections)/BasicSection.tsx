...
const BasicSection: React.FC<BasicSectionProps> = (props) => {
    ...
    const BasicDetailItem: FC<BasicDetailItemProps> = ({ field }) => {
        switch (field) {
            ...
            case "Code":
                return <ListItem label={t("Code")} value={data?.code || "-"} sx={{minHeight:"60px"}}/>;
            case "Price":
                return (
                    <ListItem
                        label={t("Price")}
            ...
            case "Manager":
                if (data.manager != null)
                    return <ListManagerItem manager={manager} sx={{minHeight:"61px"}}/>;
                else
                    return (
                        <ListItem
                            label={t("Manager")}
            ...
            case "Owner":
                if (data.owner != null) return <ListOwnerItem owner={owner} sx={{minHeight:"60px"}} />;
                else
                    return (
                        <ListItem
                            label={t("Owner")}
