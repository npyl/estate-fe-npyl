            ...
            <Grid container>
                ...
                <Grid item xs={6}>
                    <List>
                        <ListItem
                            label={t("Covered")}
                            value={areas?.covered || "" + "m²"}
                            align="horizontal"
                        />

                        <ListItem
                            label={t("Basement")}
                            value={areas?.basement || "" + "m²"}
                            align="horizontal"
                        />
                        ...
                        <ListItem
                            label={t("Balconies")}
                            value={areas?.balconies || "" + "m²"}
                            align="horizontal"
                        />

                        <ListItem
                            label={t("Storeroom")}
                            value={areas?.storeroom || "" + "m²"}
                            align="horizontal"
                        />
                    </List>
                </Grid>
