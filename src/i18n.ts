...
const resources = {
  en: {
    translation: {
      ...
      "Combined Kitchen and Dinning Area": "Combined Kitchen and Dinning Area",
      ...
      "Excluded from required PEA issue": "Excluded from required PEA issue",
      "A+": "A+",
      A: "A",
      "B+": "B+",
      B: "B",
      ...
      Entrances: "Entrances",
      "Technical Feautures And Interior": "Technical Feautures And Interior",
      Furnished: "Furnished",
      ...
      "Electric Car Charging Facilities": "Electric Car Charging Facilities",
  ...
  gr: {
    translation: {
      ...
      "Residential State": "Κατοικία",
      "Commercial State": "Επαγγελματική Στέγη",
      Land: "Γη",
      Other: "Άλλο",
      Category: "Κατηγορία",
      ...
      Price: "Τιμή",
      "Average Utils": "Μέσος Όρος Κοινόχρηστων",
