...
import FeaturesDemandSection from "./Features";
import AreaOfPreferenceDemands from "./AreaOfPreference";
...
const CustomerDemand: FC<CustomerDemandProps> = ({ demand }) => {
    ...
    return (
        <>
            ...
            <AreaOfPreferenceDemands demand={demand} />
            <FeaturesDemandSection
                features={demand?.priorityFeatures}
                parentCategories={demand?.filters?.parentCategories}
            />
        </>
    );
};

export type { CustomerDemandProps };
